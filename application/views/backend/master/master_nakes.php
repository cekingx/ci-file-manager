    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahTitle">Tambah Nakes</h5>
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="modalEditTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditTitle">Edit Nakes</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="display:block;">
                    <span aria-hidden="true" style="display:block;">&times;</span>
                </button>
            </div>
...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Master Data Nakes</h5>
            <!--end::Page Title-->
            <!--end::Actions-->
        </div>
        <!--end::Info-->
            ...
            <div class="card card-custom col-xl-12">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Master Data Nakes
                            <span class="d-block text-muted pt-2 font-size-sm">Manajemen Master Data Nakes</span></h3>
                    </div>
...
<script>
    ...
    $('.btnTambah').click(function() {
        ...
        $('#modalTambahTitle').html('Tambah Nakes');
        $('#modalTambah').modal();
    });
    ...
    $('.btnSave').click(function() {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('Master_nakes/add') ?>',
            dataType: 'json',
            data: {
                nik: $('.nik').val(),
                nama: $('.nama').val(),
    ...
    $('.btnUpdate').click(function() {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('Master_nakes/update') ?>',
            dataType: 'json',
            data: {
                kode: $('.nakes_kode').val(),
                nik: $('.nik_edit').val(),
    ...
    function get_agama() {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('Master_nakes/get_list_agama') ?>',
            dataType: 'json',
            success: function(data) {
                let html = "";
        ...
        var demo = function() {
            ...
            var datatable = $('#kt_datatable').KTDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: '<?php echo base_url('Master_nakes/get_list_nakes') ?>',
            ...
            $(document).on("click", ".btnReset", function() {
                ...
                bootbox.confirm({
                    title: "Reset password nakes/non nakes?",
                    ...
                    callback: function(result) {
                        if (result) {
                            $.ajax({
                                type: 'POST',
                                url: '<?php echo base_url('Master_nakes/reset_password') ?>',
                                data: {
                                    kode: kode,
                                },
                                dataType: 'json',
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result) {
                            $.ajax({
                                type: 'POST',
                                url: '<?php echo base_url('Master_nakes/delete') ?>',
                                data: {
                                    kode: kode,
                                },
                                dataType: 'json',
            ...
            $(document).on("click", ".btnEdit", function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('Master_nakes/get_detail') ?>',
                    dataType: 'json',
                    data: {
                        kode: kode
                    },
